...
public partial class AdventureWorksDw2019Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdventureWorksDwbuildVersion>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("AdventureWorksDWBuildVersion");
        ...
        modelBuilder.Entity<DimAccount>(entity =>
        {
            ...
            entity.HasOne(d => d.ParentAccountKeyNavigation).WithMany(p => p.InverseParentAccountKeyNavigation)
        ...
        modelBuilder.Entity<DimCurrency>(entity =>
        {
            ...
            entity.HasIndex(e => e.CurrencyAlternateKey, "AK_DimCurrency_CurrencyAlternateKey").IsUnique();
        ...
        modelBuilder.Entity<DimCustomer>(entity =>
        {
            ...
            entity.HasIndex(e => e.CustomerAlternateKey, "IX_DimCustomer_CustomerAlternateKey").IsUnique();
        ...
        modelBuilder.Entity<DimDate>(entity =>
        {
            ...
            entity.HasIndex(e => e.FullDateAlternateKey, "AK_DimDate_FullDateAlternateKey").IsUnique();
        ...
        modelBuilder.Entity<DimDepartmentGroup>(entity =>
        {
            ...
            entity.HasOne(d => d.ParentDepartmentGroupKeyNavigation).WithMany(p => p.InverseParentDepartmentGroupKeyNavigation)
        ...
        modelBuilder.Entity<DimEmployee>(entity =>
        {
            ...
            entity.HasOne(d => d.SalesTerritoryKeyNavigation).WithMany(p => p.DimEmployees)
        ...
        modelBuilder.Entity<DimGeography>(entity =>
        {
            ...
            entity.HasOne(d => d.SalesTerritoryKeyNavigation).WithMany(p => p.DimGeographies)
                .HasForeignKey(d => d.SalesTerritoryKey)
        ...
        modelBuilder.Entity<DimOrganization>(entity =>
        {
            ...
            entity.HasOne(d => d.CurrencyKeyNavigation).WithMany(p => p.DimOrganizations)
                .HasForeignKey(d => d.CurrencyKey)
                .HasConstraintName("FK_DimOrganization_DimCurrency");

            entity.HasOne(d => d.ParentOrganizationKeyNavigation).WithMany(p => p.InverseParentOrganizationKeyNavigation)
        ...
        modelBuilder.Entity<DimProductCategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductCategoryAlternateKey, "AK_DimProductCategory_ProductCategoryAlternateKey").IsUnique();
        ...
        modelBuilder.Entity<DimProductSubcategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductSubcategoryAlternateKey, "AK_DimProductSubcategory_ProductSubcategoryAlternateKey").IsUnique();
        ...
        modelBuilder.Entity<DimPromotion>(entity =>
        {
            ...
            entity.HasIndex(e => e.PromotionAlternateKey, "AK_DimPromotion_PromotionAlternateKey").IsUnique();
        ...
        {
            entity.HasKey(e => e.ResellerKey).HasName("PK_DimReseller_ResellerKey");

            entity.ToTable("DimReseller");

            entity.HasIndex(e => e.ResellerAlternateKey, "AK_DimReseller_ResellerAlternateKey").IsUnique();
            ...
            entity.HasOne(d => d.GeographyKeyNavigation).WithMany(p => p.DimResellers)
                .HasForeignKey(d => d.GeographyKey)
        ...
        {
            entity.HasKey(e => e.SalesReasonKey).HasName("PK_DimSalesReason_SalesReasonKey");
        ...
        modelBuilder.Entity<DimSalesTerritory>(entity =>
        {
            ...
            entity.HasIndex(e => e.SalesTerritoryAlternateKey, "AK_DimSalesTerritory_SalesTerritoryAlternateKey").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.ProductKey, e.CultureName }).HasName("PK_FactAdditionalInternationalProductDescription_ProductKey_CultureName");
        ...
        {
            entity.HasKey(e => e.FactCallCenterId).HasName("PK_FactCallCenter_FactCallCenterID");

            entity.ToTable("FactCallCenter");

            entity.HasIndex(e => new { e.DateKey, e.Shift }, "AK_FactCallCenter_DateKey_Shift").IsUnique();
            ...
            entity.HasOne(d => d.DateKeyNavigation).WithMany(p => p.FactCallCenters)
        ...
        {
            entity.HasKey(e => new { e.CurrencyKey, e.DateKey }).HasName("PK_FactCurrencyRate_CurrencyKey_DateKey");

            entity.ToTable("FactCurrencyRate");

            entity.Property(e => e.Date).HasColumnType("datetime");

            entity.HasOne(d => d.CurrencyKeyNavigation).WithMany(p => p.FactCurrencyRates)
                .HasForeignKey(d => d.CurrencyKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactCurrencyRate_DimCurrency");

            entity.HasOne(d => d.DateKeyNavigation).WithMany(p => p.FactCurrencyRates)
                .HasForeignKey(d => d.DateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.SalesOrderNumber, e.SalesOrderLineNumber }).HasName("PK_FactInternetSales_SalesOrderNumber_SalesOrderLineNumber");
            ...
            entity.HasOne(d => d.CurrencyKeyNavigation).WithMany(p => p.FactInternetSales)
                .HasForeignKey(d => d.CurrencyKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactInternetSales_DimCurrency");

            entity.HasOne(d => d.CustomerKeyNavigation).WithMany(p => p.FactInternetSales)
                .HasForeignKey(d => d.CustomerKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactInternetSales_DimCustomer");

            entity.HasOne(d => d.DueDateKeyNavigation).WithMany(p => p.FactInternetSaleDueDateKeyNavigations)
                .HasForeignKey(d => d.DueDateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactInternetSales_DimDate1");

            entity.HasOne(d => d.OrderDateKeyNavigation).WithMany(p => p.FactInternetSaleOrderDateKeyNavigations)
                .HasForeignKey(d => d.OrderDateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactInternetSales_DimDate");

            entity.HasOne(d => d.ProductKeyNavigation).WithMany(p => p.FactInternetSales)
                .HasForeignKey(d => d.ProductKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactInternetSales_DimProduct");

            entity.HasOne(d => d.PromotionKeyNavigation).WithMany(p => p.FactInternetSales)
                .HasForeignKey(d => d.PromotionKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactInternetSales_DimPromotion");

            entity.HasOne(d => d.SalesTerritoryKeyNavigation).WithMany(p => p.FactInternetSales)
                .HasForeignKey(d => d.SalesTerritoryKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactInternetSales_DimSalesTerritory");

            entity.HasOne(d => d.ShipDateKeyNavigation).WithMany(p => p.FactInternetSaleShipDateKeyNavigations)
                .HasForeignKey(d => d.ShipDateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactInternetSales_DimDate2");

            entity.HasMany(d => d.SalesReasonKeys).WithMany(p => p.SalesOrders)
                .UsingEntity<Dictionary<string, object>>(
                    "FactInternetSalesReason",
                    r => r.HasOne<DimSalesReason>().WithMany()
                        .HasForeignKey("SalesReasonKey")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_FactInternetSalesReason_DimSalesReason"),
                    l => l.HasOne<FactInternetSale>().WithMany()
        ...
        modelBuilder.Entity<FactProductInventory>(entity =>
        {
            ...
            entity.HasOne(d => d.DateKeyNavigation).WithMany(p => p.FactProductInventories)
                .HasForeignKey(d => d.DateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactProductInventory_DimDate");

            entity.HasOne(d => d.ProductKeyNavigation).WithMany(p => p.FactProductInventories)
                .HasForeignKey(d => d.ProductKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.SalesOrderNumber, e.SalesOrderLineNumber }).HasName("PK_FactResellerSales_SalesOrderNumber_SalesOrderLineNumber");
            ...
            entity.HasOne(d => d.CurrencyKeyNavigation).WithMany(p => p.FactResellerSales)
                .HasForeignKey(d => d.CurrencyKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactResellerSales_DimCurrency");

            entity.HasOne(d => d.DueDateKeyNavigation).WithMany(p => p.FactResellerSaleDueDateKeyNavigations)
                .HasForeignKey(d => d.DueDateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactResellerSales_DimDate1");

            entity.HasOne(d => d.EmployeeKeyNavigation).WithMany(p => p.FactResellerSales)
                .HasForeignKey(d => d.EmployeeKey)
                .HasConstraintName("FK_FactResellerSales_DimEmployee");

            entity.HasOne(d => d.OrderDateKeyNavigation).WithMany(p => p.FactResellerSaleOrderDateKeyNavigations)
                .HasForeignKey(d => d.OrderDateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactResellerSales_DimDate");

            entity.HasOne(d => d.ProductKeyNavigation).WithMany(p => p.FactResellerSales)
                .HasForeignKey(d => d.ProductKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactResellerSales_DimProduct");

            entity.HasOne(d => d.PromotionKeyNavigation).WithMany(p => p.FactResellerSales)
                .HasForeignKey(d => d.PromotionKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactResellerSales_DimPromotion");

            entity.HasOne(d => d.ResellerKeyNavigation).WithMany(p => p.FactResellerSales)
                .HasForeignKey(d => d.ResellerKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactResellerSales_DimReseller");

            entity.HasOne(d => d.SalesTerritoryKeyNavigation).WithMany(p => p.FactResellerSales)
                .HasForeignKey(d => d.SalesTerritoryKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactResellerSales_DimSalesTerritory");

            entity.HasOne(d => d.ShipDateKeyNavigation).WithMany(p => p.FactResellerSaleShipDateKeyNavigations)
                .HasForeignKey(d => d.ShipDateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<FactSalesQuotum>(entity =>
        {
            ...
            entity.HasOne(d => d.EmployeeKeyNavigation).WithMany(p => p.FactSalesQuota)
                .HasForeignKey(d => d.EmployeeKey)
        ...
        {
            entity.HasKey(e => e.SurveyResponseKey).HasName("PK_FactSurveyResponse_SurveyResponseKey");
            ...
            entity.HasOne(d => d.CustomerKeyNavigation).WithMany(p => p.FactSurveyResponses)
                .HasForeignKey(d => d.CustomerKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FactSurveyResponse_CustomerKey");

            entity.HasOne(d => d.DateKeyNavigation).WithMany(p => p.FactSurveyResponses)
                .HasForeignKey(d => d.DateKey)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.ProspectiveBuyerKey).HasName("PK_ProspectiveBuyer_ProspectiveBuyerKey");
